...
class _MoodScreenState extends State<MoodScreen> {
  ...
  void _logMood(MoodData mood) {
    ...
    moodBox.put(now.toString(), mood.moodText);  // Store mood with timestamp
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            ...
            onPressed: () => Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => MoodStatisticsScreen()),
            ),
          ),
        ],
      ),
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          final mood = moodData[index];
          return ListTile(
            title: Text(mood.moodText),
            trailing: ElevatedButton(
              onPressed: () => _logMood(mood),
              child: Text(mood.buttonText),
            ),
          );
        },
      ),
