...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  void _logMood(MoodData mood) {
    final now = DateTime.now();
    moodBox.put(now.toString(), mood.moodText); 
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text('Mood Logged: ${mood.moodText}')),
    );
  }
        ...
        children: [
          ...
          Align(
            ...
            child: Padding(
              ...
              child: CustomButton(
                buttonText: moodData[_currentPage].buttonText, // Use current page's mood
                onPressed: () {
                  // Log the mood of the current page
                  _logMood(moodData[_currentPage]);
  ...
  void pageChangeCallback(int page) {
    setState(() {
      _currentPage = page; // Update current page when the page changes
    });
  }
}
